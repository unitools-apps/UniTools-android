...
public class Alarm15MinRepeat extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        CloseToClassNotify.on15Min(context);
    ...
    private void setAlarm(Context context, int min) {
        ...
        manager.setRepeating(AlarmManager.RTC_WAKEUP, Calendar.getInstance().getTimeInMillis() + min * 60 * 1000, interval, pendingIntent);
    }
}
