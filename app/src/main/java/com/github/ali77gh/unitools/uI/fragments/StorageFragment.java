...
public class StorageFragment extends Fragment implements Backable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //test
        List<StoragePack> lst = new ArrayList<>();
        lst.add(new StoragePack("ممد", 20, 6));
        lst.add(new StoragePack("جعفری", 32, 2));
        lst.add(new StoragePack("پایگاه داده", 18, 16));
        lst.add(new StoragePack("فیلان", 103, 3));
        lst.add(new StoragePack("بیسار", 2, 1));
